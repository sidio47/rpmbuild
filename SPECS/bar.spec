...
local help_msg=[[
The bar package provides a nice little spec file template for creating RPMs
ready for TACC integration.
...
whatis("Category: Template spec file"                 )
whatis("Keywords: TACC Template"                      )
whatis("Description: Template for generation of RPMs" )
whatis("URL: https://github.com/TACC/hpc_spec"        )
